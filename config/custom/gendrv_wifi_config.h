...
//  define your robot' specs here
#define MOTOR_MAX_RPM 178               // motor's max RPM
#define MAX_RPM_RATIO 0.85              // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO
#define MOTOR_OPERATING_VOLTAGE 12      // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 12      // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 12 // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 616             // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 616             // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 616             // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 616             // wheel4 encoder's no of ticks per rev
...
#define AGENT_IP {10, 42, 0, 1} // eg IP of the desktop computer
#define AGENT_PORT 8888
// Enable WiFi with null terminated list of multiple APs SSID and password
#define WIFI_AP_LIST                                    \
  {                                                     \
    {"Wall-e Fallback network", "0123456789"}, { NULL } \
  }
#define WIFI_MONITOR 2 // min. period to send wifi signal strength to syslog
#define USE_ARDUINO_OTA
#define USE_SYSLOG
#define SYSLOG_SERVER {10, 42, 0, 1} // eg IP of the desktop computer
